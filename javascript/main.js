...
const myArray = ['Mercedes', 'Tesla', 'Toyota', 'Volkswagen', 'Renault', 'Seat'];
myArray.push ('Ferrari');
for (let i = 0 ; i < myArray.length; i ++) {
    const myCarsContent = document.querySelector(".mycars");
    const carName = myArray[i];
    console.log(carName);
    myCarsContent.innerHTML += carName + "<br>"
    if (i == 2) {
        console.log("================");
        myCarsContent.innerHTML += "================" + "<br>";
    }else if (i == 5) {
        console.log("================");
        myCarsContent.innerHTML += "================" + "<br>";
    }
...
let aantalRijn;
aantalRijn = myArray.length - 1;
aantalRijn = aantalRijn / 3;
console.log(aantalRijn);
